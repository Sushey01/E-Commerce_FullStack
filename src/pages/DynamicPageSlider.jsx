    ...
    const fetchProducts = async () => {
      ...
      if (data) {
        const mappedData = data.map((product) => {
          ...
          const image =
            firstImage && /^https?:\/\//i.test(firstImage)
              ? firstImage
        ...
        // If you have real category mapping, filter by category_id; otherwise show latest for all three sections
        const latest = mappedData;
        setFeatureProductsState(latest);
        setMonthlySaleProductsState(latest);
        setLaptopProductsState(latest);
      }
