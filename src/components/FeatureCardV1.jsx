    ...
    <>
      ...
      <div
        ...
        <div className="flex justify-center gap-1 w-full">
          <p className="text-xl md:text-2xl text-[#777]">{title1}</p>
          <p className="text-xl md:text-2xl text-[#777]">{title2}</p>
        </div>

        <p className="text-[#777]  text-sm md:text-base line-clamp-1">
          {subtitle}
        </p>
