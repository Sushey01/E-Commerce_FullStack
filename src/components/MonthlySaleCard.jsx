...
<div className="p-3 bg-[#f7f7f7] md:justify-items-center border rounded hover:shadow w-full max-w-sm mx-auto">
      ...
      <div className="flex justify-center items-center gap-1 text-yellow-400 text-sm mb-2">
        ...
        <span className="ml-1 text-[10px] md:text-[12px]  text-gray-600">25 Reviews</span>
      </div>

      {/* 💰 Pricing */}
      <div className="mb-2 flex flex-wrap gap-2 justify-center">
        <p className="  text-[12px] text-gray-400 line-through flex items-center">Rs. 2,70,000</p>
