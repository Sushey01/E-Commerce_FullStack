...
<div className="p-4 bg-[#f7f7f7] md:justify-items-center border rounded shadow w-full max-w-sm mx-auto">
      ...
      <p className="text-lg font-semibold mb-1">Apple MacBook</p>
      ...
      <div className="mb-2">
        ...
        <p className="text-xl font-bold text-green-600">Rs. 2,50,000</p>
      </div>

      {/* 📦 Stock & Sales Info */}
      <div className="flex items-center justify-center gap-3 mb-3">
        <p className="text-sm  text-gray-600 ">620 Sold</p>
