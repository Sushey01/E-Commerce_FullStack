  ...
  return (
    <div className="p-3 py-2 bg-[#f7f7f7]  md:justify-items-center border rounded hover:shadow w-full max-w-sm mx-auto">
      ...
      <div className="flex justify-center items-center gap-1 text-yellow-400 text-sm mb-2">
        ...
        <span className="ml-1 text-[12px] lg:text-sm text-gray-600">
          {reviewsCount}
        </span>
      </div>
      ...
      <div className="mb-2 flex  gap-2 justify-center">
        <p className="  text-[10px] md:text-xs  text-gray-400 line-through flex items-center">
          {actualPrice}
        </p>
        <p className="text-sm lg:text-[15px]  font-bold text-green-600">
          {discountedPrice}
        </p>
      </div>
      ...
      <div className=" items-center justify-center gap-3 mb-3 flex">
        <p className="md:text-sm text-[12px] text-gray-600 line-clamp-1 ">
          {totalSold}
        </p>
        <div className="flex items-center gap-1 text-[12px]  md:text-sm text-gray-800">
          ...
          <span className="line-clamp-1">{stockLeft}</span>
        </div>
      </div>

      {/* 🛒 CTA */}
    {/* <div className="w-full flex justify-center"> */}
  <button className="w-full text-[#0296a0] p-1.5 border rounded-full md:hover:bg-[#0296a0] md:hover:text-white transition">
    {label}
  </button>
{/* </div> */}
