...
const Navbar = () => {
  ...
  return (
    <>
      {/* Top Search Drawer - mobile only */}
      {toggleSearch && (
        <div className="fixed top-0 left-0 right-0 z-50 bg-white dark:bg-gray-900 p-4 shadow-md transition-transform transform md:hidden animate-slideIn">
          ...
          <div className=" mb-4">
            <select className="w-full border rounded px-3 py-2 md:w-[50%]">
